...
pub const BackupEngine = database.BackupEngine;
pub const BackupInfo = database.BackupInfo;
pub const Checkpoint = database.Checkpoint;
pub const RestoreOptions = database.RestoreOptions;
